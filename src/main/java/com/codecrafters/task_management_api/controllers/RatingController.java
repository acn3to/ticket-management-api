...
import com.codecrafters.task_management_api.services.RatingService;
...
public class RatingController {
    ...
    @PostMapping
    public RatingModel publishRating(@RequestBody RatingModel ratingModel) {
        return ratingService.publishRating(ratingModel);
    }
}
