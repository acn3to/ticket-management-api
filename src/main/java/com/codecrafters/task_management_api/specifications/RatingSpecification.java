...
public class RatingSpecification {
    ...
    public static Specification<RatingModel> hasEvent(EventModel event) {
        return (root, query, criteriaBuilder) ->
                event == null ? null : criteriaBuilder.equal(root.get("event"), event);
    }

//    public static Specification<RatingModel> hasUser(UserModel user) {
//        return (root, query, criteriaBuilder) ->
...
//    }
    ...
    public static Specification<RatingModel> hasRatingBetween(BigDecimal minRating, BigDecimal maxRating) {
        return (root, query, criteriaBuilder) ->
                (minRating == null || maxRating == null) ? null : criteriaBuilder.between(root.get("rating"), minRating, maxRating);
    }

    public static Specification<RatingModel> hasReviewContaining(String review) {
        return (root, query, criteriaBuilder) ->
                review == null ? null : criteriaBuilder.like(criteriaBuilder.lower(root.get("review")), "%" + review.toLowerCase() + "%");
    }
